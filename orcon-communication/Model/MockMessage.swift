...
internal struct MockMessage: MessageType {
    ...
    init(attributedText: NSAttributedString, sender: Sender, messageId: String, date: Date, isRead:Bool) {
        self.init(kind: .attributedText(attributedText), sender: sender, messageId: messageId, date: date)
        self.innertext = attributedText.string
        self.isRead = isRead
    }
    
    init(image: UIImage, sender: Sender, messageId: String, date: Date, isRead:Bool) {
